...
This course will be your first introduction to the concepts of data structures and algorithms: the standard ways of representing and manipulating information in computer programs. A thorough knowledge of data structures and algorithms will **help you solve hard problems**. Most top-tier tech companies ask questions about data structures and algorithms as part of their interviews.

## Learning Outcomes

At the end of this course, you will be able to:

1. Write medium-sized Java programs combining multiple object-oriented programming features.

2. Know and use the most common data structures: arrays, lists, stacks, queues, hash tables, search trees, and heaps

3. Be familiar with the concept of algorithmic complexity and be able to express the complexity of
common algorithms and data structure operations in Big-O notation.

4. Understand common algorithms for searching (linear and binary search) and sorting (simple quadratic sorts, quicksort, mergesort). Use 
complexity analysis to draw useful conclusions about their behaviors.

5. Design and implement recursive programs.

6. Intelligently discuss algorithm and data structure choices and tradeoffs.

## Textbook

We will use an online ZyBook covering Java, object-oriented programming, and data structures. The text includes built-in problems that 
you will complete along with the assigned homework projects. In most cases, the questions for each book chapter will be due at the same 
time as a programming project.

To access the text, create an account on the ZyBooks site, https://learn.zybooks.com. Enter the ZyBook code: 
ROLLINSCMS170MyersSpring2020. The subscription is $88 and lasts until after the final exam. Note that you can't subscribe to the book after the end of April, but it will remain open for you to access until the middle of May after final exams.

## Schedule

### Units

| Units       | Topic                           | Deliverable     | Learning Outcomes |
| -------------|---------------------------------|-----------------|----------|
| 1            | Review of Core Java programming | Get Back in Shape with Java | 1 |
| 2            | 1-D and 2-D Arrays              | Notakto     | 1, 2  |
| 3            | More Objects   |  Conway's Life   | 1 |
| 4            | Array Lists | Snek | 1, 2 |
| 5            | Searching, Sorting, Complexity, and Big-O |   | 1, 2, 3, 4 |
| 7            | Recursion and Recurrence Relations              | Practice Problems  | 1, 3, 5 |
| 8            | Fancy Sorting: Quicksort and Mergesort  |    | All |
| 9            | Linked Lists             | Data Structure Implementation | All |
| 10            | Stacks and Queues | Byte Code Interpreter  | 1, 2, 3, 6 |
| 11            | Hash Tables |    | 1, 2, 3, 6 |
| 12            | Trees: Search Trees and Heaps |    | All |
| 13            | Putting It All Together: Minimax and AI             | Unbeatable Game  | All |

### Other Important Dates

- First day of class: Tuesday, January 14
- Last day of class: Tuesday, April 28
- MLK Day: Monday, January 20
- Spring Break: Saturday, 3/14 to Sunday 3/22
...
We'll have five kinds of required assignments:

1. Approximately eight homework projects.
2. Autograded practice questions in the ZyBook, typically due with each project.
3. Short reflective self-assessments completed along with each project.
4. A written midterm exam.
5. A written final exam. The final will only cover the second half of the course.
...
1. Satisfactory completion of *N - 1* homework projects (I'll drop one bad project).
2. Satisfactory completion of at least 90% of the assigned questions on each ZyBook chapter.
3. Satisfactory completion of all reflective self-assessments.
4. Satisfactory completion of the midterm and final exams.
...
3. It gives you choices for how to attain higher grades. You don't have to do every project.
